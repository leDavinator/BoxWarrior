...
class Enemy(pygame.sprite.Sprite): #defines enemy class
    ...
    def movement(self):
        ...
        if 150 > warrior.rect.y - self.rect.y > -150 and 150 > warrior.rect.x - self.rect.x > -150:   #enemy seeking player
...
while playAgain == True:
    ...
    while finalLoop == True:
        ...
        replay = font.render('Press 1 to replay or 2 to exit the game', True, (255,255,255))
        screen.blit(replay, (100, 500))
